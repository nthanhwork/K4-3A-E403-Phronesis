...
- **Evidence (Chuẩn A và Chuẩn B — Log đầy đủ trong repo):**
  - *Số liệu khảo sát ($n = 6$ TA/Lab Coach thực tế ngày 16/9/2026):*
    - **83.3% (5/6 TA)** xác nhận mất nhiều thời gian mỗi ngày chỉ để cuộn chuột lội kênh tìm câu hỏi.
    - **Kỷ lục câu hỏi bị tồn đọng:** 12 tiếng (TA 1), 6–10 tiếng (TA 3), và 7 tiếng (TA 5).
    - **13% – 30%** câu hỏi trong ngày bị trùng lặp nội dung.
  - *≥5 Quote nguyên văn từ người dùng thật:*
    1. *"Quá nhiều tin mà phải đọc hết"* — TA (Dòng 13, Form khảo sát TA)
    2. *"Bị trôi tin nhắn"* — TA (Dòng 15, Form khảo sát TA)
    3. *"Khó nắm bắt tình hình nếu bỏ lỡ câu chuyện khá lâu"* — TA (Dòng 14, Form khảo sát TA)
    4. *"Bỏ qua luôn"* (khi gặp câu hỏi trùng lặp vì nản) — TA (Dòng 14, Form khảo sát TA)
    5. *"Mất thời gian đi research"* & *"Dò thủ công"* — TA (Dòng 12, Form khảo sát TA)
